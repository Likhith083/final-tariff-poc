...
async def chat_health():
    """Health check for chat service, ChromaDB, and Ollama."""
    chroma_status = 'disconnected'
    ollama_status = 'disconnected'
    try:
        # Check ChromaDB
        if ai_service and ai_service.search_service and ai_service.search_service.collection:
            chroma_status = 'connected'
    except Exception:
        chroma_status = 'disconnected'
    try:
        # Check Ollama
        if ai_service and hasattr(ai_service, 'model_name') and ai_service.model_name:
            ollama_status = 'connected'
    except Exception:
        ollama_status = 'disconnected'
    return {"chroma": chroma_status, "ollama": ollama_status} 